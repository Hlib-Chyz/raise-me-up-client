...
export interface IInfo {
    type: TextType;
    text?: string;
    list?: { bold: string; regular: string }[];
}
...
export const getCurrentInfoState = (state: IStore) =>
    state.pagination.pages.find((page) => page.id === state.pagination.currentPage)?.info;
export const getCurrentTabState = (state: IStore) =>
    state.pagination.pages.find((page) => page.id === state.pagination.currentPage);
